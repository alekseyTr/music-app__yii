...
class TracksController extends Controller
{
  ...
  // $this->performAjaxValidation($model);
	...
	{
		$dataProvider=new CActiveDataProvider('Tracks');
	...
	{
		$model=new Tracks('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tracks']))
			$model->attributes=$_GET['Tracks'];
	 ...
	 * @param Tracks $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tracks-form')
		{
